  ...
  return (
    <form className={style.containerForm}>
      <div className={style.heading}>
        <h3 className={style.title}>Weekly Newsletter</h3>
        <p className={style.text}>Get blog articles and offers via email</p>
      </div>
      ...
      <div className={style.inputSubmit}>
        <input type="submit" placeholder="Subscribe" className={style.send} />
      </div>
    </form>
  );
}
